...
function Document(db, raw) 
{
  ...
  Object.defineProperty(this, "copy", { value: function(strict) { 
    return deepCopy(self, strict);
  }, writable: false });

  Object.defineProperty(this, "serialize", { value: function(strict) {
    return serialize(self);
  }, writable: false });

  // Special methods
  for (var method in db._methods) Object.defineProperty(this, method, { value: db._methods[method], writable: false });

  // Persist to LevelUP
  Object.defineProperty(this, "_persist", { value: function(cb, quiet) {
  ...
  _.extend(this, _.cloneDeep(raw)); // TODO: this can be more optimized and save a few additional property assignemnts
