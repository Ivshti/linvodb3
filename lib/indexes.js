...
function Index (options) {
  ...
  this.treeOptions = { unique: this.unique, compareKeys: document.compareThings, checkValueEquality: checkValueEquality };
...
Index.prototype.insert = function (doc) {
  ...
  key = document.getDotValue(doc, this.fieldName);
 ...
 * @return {Array of documents}
 */
Index.prototype.getAll = function (sparse) {
  var res = [];

  this.tree.executeOnEveryNode(function (node) {
    if (sparse && node.key === undefined) return;
