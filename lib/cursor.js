...
Cursor.prototype.live = function(query) {
  ...
  function stop() {
    ...
    this.db.removeListener("reload", refreshWrapper);
    this.db.removeListener("liveQueryRefresh", refreshWrapper);
  }

  this.db.on("updated", updated);
  this.db.on("inserted", updated);
  this.db.on("removed", removed);
  this.db.on("reload", refreshWrapper); // Refresh on DB reload
  this.db.on("liveQueryRefresh", refreshWrapper); // Refresh on this event
