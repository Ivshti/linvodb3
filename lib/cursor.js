...
Cursor.getIdsForQuery = function(db, query, sort) {
  ...
  _.each(query, function(value, key) {
    ...
    if (index && (indexed || !db.options.autoIndexing)) {
      ...
      else if (value.hasOwnProperty("$ne")) exclude(index.getMatching(value.$ne));
      else if (value.hasOwnProperty("$in")) push(index.getMatching(value.$in));
      else if (value.hasOwnProperty("$nin")) exclude(index.getMatching(value.$nin));
      ...
      else if (value.hasOwnProperty("$exists") && value.$exists==true) push(index.getAll(function(n) { return n.key!==undefined }));
      else if (value.hasOwnProperty("$exists") && value.$exists==false) push(index.getAll(function(n) { return n.key===undefined })); 
