...
=======
  , hat = require('hat')
    , encode = require('encoding-down') ;
>>>>>>> 48d533b58e0ded6111daf74ae17ad53de624f13a
...
<<<<<<< HEAD
  this.store = stores[path.resolve(filename)] = (this.store && this.store.isOpen()) ? this.store : levelup(encode(leveldown(filename)), this.options.store || { });
=======
