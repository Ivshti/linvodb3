...
function Model (name, schema, options) {
  ...
  _.extend(self, Model.prototype); // Might be ugly...
 ...
 */
Model.prototype.getCandidates = function (query, sort, callback) {
  var self = this;
 ...
 */
Model.prototype.find = function (query, projection, callback) {
 ...
 * @param {Object} projection MongoDB-style projection
 */
Model.prototype.findOne = function (query, projection, callback) {
  switch (arguments.length) {
    case 1:
      projection = {};
      // callback is undefined, will return a cursor
