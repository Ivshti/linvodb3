...
Model.prototype.insert = function (newDoc, cb) {
  ...
  self._pipe.push(function(callback) {
    ...
    async.map(util.isArray(newDoc) ? newDoc : [newDoc], function(d, cb) { (new self(d)).save(cb) }, function(err, docs) {
  ...
  stream.on("ids", function(ids) {
    ...
    stream.on("ready", function() {
      ...
      async.map(modifications, function(d, cb) {
        (new self(d.newDoc)).save(function(err, doc) { d.unlock(); cb(err, doc) });
      }, function(err, docs) {
        callback(err || null, 
